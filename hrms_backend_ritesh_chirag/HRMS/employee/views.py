...
class EmployeeActivity(viewsets.ModelViewSet):
    ...
    def get_queryset(self): 
        ...
        if self.request.user.is_superuser:
            if id:
                return TodaysEmployeeActivity.objects.filter(employee_id=id,
                                                             status_time__year=today.year,
                                                    status_time__month=today.month,
                                                    status_time__day=today.day).order_by("-status_time")
        else:
...
class  UpdateAttendanceEmployee(viewsets.ModelViewSet):
    pass
